...
// triton-ascend 3.5.0 does not generate triton/Version.h (upstream 3.7 does
// via Version.h.in + CMake configure_file). Define TRITON_VERSION here so
// version checks compile. When triton-ascend adds Version.h generation,
// this define can be dropped in favor of the real header.
#ifndef TRITON_VERSION
#define TRITON_VERSION "3.5.0"
#endif
